                        ...
                        <div :class="style.uniaspecto2">
                            <div  >
                                <div v-for="(find,index) in dato3"  :key="find.id">
                                    ...
                                    <!--input :class="style.uniaspecto3" list="HemisferiosyCuadrantes" v-model="find.value" :key="index" placeholder="__cuadrantes">
...
import style from "./hemisferio.module.css"
